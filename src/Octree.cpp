...
*/
OctreeNode::OctreeNode(const Boite &reperBoite, OctreeNode *parent) : _particle(),
                                                                       _mass(0),
                                                                       _cm(),
                                                                       _boite(reperBoite),
                                                                       _center((reperBoite.point1.x + (reperBoite.point2.x / 2)), (reperBoite.point1.y + (reperBoite.point2.y / 2)), (reperBoite.point1.z + (reperBoite.point2.z / 2))),
                                                                       _parent(parent),
                                                                       _num(0),
                                                                       _bSubdivided(false)
{
